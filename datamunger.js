function splitStringBySpace(queryString) {
    var splitArray = [];
...
console.log("\n\n\===============================================================================================================\n\n");
function getFileName(queryString) {
    var tempString = queryString.split("from");
    var splitString = tempString[1].trim().split(" ");
...
console.log("\n\n\===============================================================================================================\n\n");
function getBaseQuery(queryString) {
    var splitArray;
...
function getFields(queryString) {
    var splitString = [];
    var splitArray = [];
    var tempString = queryString.split(" ");
...
console.log("\n\n\===============================================================================================================\n\n");
function getConditionPartQuery(queryString) {
    var splitString = [];
    var str = "";
    if (queryString.search("where")) {
...
console.log("\n\n\===============================================================================================================\n\n");
function getOrderByFields(queryString) {
    var splitString = [];
    var str = "";
    if (queryString.search("order by")) {
...
console.log("\n\n\===============================================================================================================\n\n");
function getGroupByFields(queryString) {
    var splitString = [];
    var str = "";
    if (queryString.search("group by")) {
...
console.log("\n\n\===============================================================================================================\n\n");
function getAggregateFields(queryString) {
    var arr1 = [];
    var arr2 = [];
    var arr3 = [];
    var arr4 = [];
...
console.log("\n\n\===============================================================================================================\n\n");
function getConditionFields(queryString) {
    var arr1 = [];
    var arr2 = [];
    var str = "";
    var index = 0;
...
console.log("\n\n\===============================================================================================================\n\n");
function getLogicalOperators(queryString) {
    var arr1 = [];
    var arr2 = [];
    var arr3 = [];
    var str = "";
